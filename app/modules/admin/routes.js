...
//MAINTENANCE
router.get('/branch', viewUtils, viewAdmin, viewBranch, branch);
router.get('/category', viewUtils, viewAdmin, viewCategory, category);
router.get('/classes', viewUtils, viewAdmin, viewClass, classes);
router.get('/discount', viewUtils, viewAdmin, viewDiscount, discount);
router.get('/membership', viewUtils, viewAdmin, viewclassdrop, viewMembership, viewcatdrop, membership);
router.get('/specialization', viewUtils, viewAdmin, viewSpecial, specs);
router.get('/staff',viewUtils, viewAdmin, viewBranches, viewStaff, staff);
router.get('/trains', viewUtils, viewAdmin, viewTrainer, viewspecialdrop, viewbranchdrop, trains);
router.get('/memclass', viewUtils, viewAdmin, viewHie, memclass);
router.get('/ORs',viewUtils, viewAdmin, viewOR,ORs);
