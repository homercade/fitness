...
SignupRouter.route('/')
    ...
    .post(useraddid,(req, res) => {
        var db = require('../../lib/database')();
            ...
            code = autogen;
                db.query("INSERT INTO tbluser (userfname, userlname, usergender, userbday, useraddress, usermobile, useremail, userusername,branch, usertype) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, 2 ) ",[ req.body.fname, req.body.lname, req.body.gen, req.body.bday, addr, req.body.mobile, req.body.email, req.body.username, req.body.branch], (err, results, fields)=>{
                    db.query("INSERT INTO tblmembership (usersid,membershiprateid, specializationid, paymentcode, status) VALUES (?, ?, ?, ?, 'Pending' ) ",[ req.newuserid, req.body.membership, req.body.specs, autogen], (err, results, fields)=>{
                        db.query("INSERT INTO tblpayment (userid) VALUES (?) ", [req.newuserid], (err, results, fields) => {
